...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=experiment-full(100/EL/1.3B)
#SBATCH --mem=32000
...
# python ./trainer.py --config_file exp-configs/Europarl/100/config-1.3B-el.json
python ./extraction.py --config_file exp-configs/Europarl/100/config-1.3B-el.json --model_dir /scratch/s6153712/llm-privacy/hf_cache/finetuned/Europarl/el-100-100-1.3B
