...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=experiment-full(100/ES/2.7B)
#SBATCH --mem=16000
...
python ./trainer.py --config_file exp-configs/Europarl/100/config-2.7B-es.json
# python ./extraction.py --config_file exp-configs/Europarl/100/config-2.7B-es.json --model_dir /scratch/s6153712/llm-privacy/hf_cache/finetuned/Europarl/es-100-100-2.7B
