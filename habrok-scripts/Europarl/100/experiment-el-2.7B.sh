...
# python ./trainer.py --config_file exp-configs/Europarl/100/config-2.7B-el.json
python ./extraction.py --config_file exp-configs/Europarl/100/config-2.7B-el.json --model_dir /scratch/s6153712/llm-privacy/hf_cache/finetuned/Europarl/el-100-100-2.7B
