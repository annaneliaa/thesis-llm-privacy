...
# python ./trainer.py --config_file exp-configs/EMEA/200/config-125M-es.json
CUDA_LAUNCH_BLOCKING=1 python ./extraction.py --config_file exp-configs/EMEA/200/config-125M-es.json --model_dir /scratch/s6153712/llm-privacy/hf_cache/finetuned/EMEA/es-200-100-125M --cache_dir /scratch/s6153712/llm-privacy/hf_cache/
