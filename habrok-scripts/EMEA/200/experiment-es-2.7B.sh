...
# python ./trainer.py --config_file exp-configs/EMEA/200/config-2.7B-es.json
python ./extraction.py --config_file exp-configs/EMEA/200/config-2.7B-es.json --model_dir /scratch/s6153712/llm-privacy/hf_cache/finetuned/EMEA/es-200-100-2.7B --cache_dir /scratch/s6153712/llm-privacy/hf_cache/
