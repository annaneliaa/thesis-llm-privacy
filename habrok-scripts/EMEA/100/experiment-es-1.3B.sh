...
# python ./trainer.py --config_file exp-configs/EMEA/100/config-1.3B-es.json
python ./extraction.py --config_file exp-configs/EMEA/100/config-1.3B-es.json --model_dir /scratch/s6153712/llm-privacy/hf_cache/finetuned/EMEA/es-100-100-1.3B
