...
# python ./trainer.py --config_file exp-configs/EMEA/100/config-2.7B-es.json
python ./extraction.py --config_file exp-configs/EMEA/100/config-2.7B-es.json --model_dir /scratch/s6153712/llm-privacy/hf_cache/finetuned/EMEA/es-100-100-2.7B
