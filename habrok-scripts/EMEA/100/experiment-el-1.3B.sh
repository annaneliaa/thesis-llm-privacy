...
# python ./trainer.py --config_file exp-configs/EMEA/100/config-1.3B-el.json
python ./extraction.py --config_file exp-configs/EMEA/100/config-1.3B-el.json --model_dir /scratch/s6153712/llm-privacy/hf_cache/finetuned/EMEA/el-100-100-1.3B
